...
export const projectsData: ProjectItem[] = [
  {
    ...
    delivery: 'Projet clé en main',
    results: '+240% de réservations directes sans commissions tierces',
    clientName: 'Jean-Marc R.',
    clientRole: 'Directeur Général, Éco-Lodge Nosy Be',
    testimonial: '« Avant PixelStudio, 80% de nos réservations passaient par des plateformes qui prélevaient 18% de commission. Avec notre nouveau site ultra-rapide et responsive, nous avons signé 6 séjours directs via le module WhatsApp intégré dès la première semaine ! »',
  ...
  },
  {
    ...
    delivery: 'E-commerce sur-mesure',
